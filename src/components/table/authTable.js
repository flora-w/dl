...
import { Table, Input, Tag, Button, Form, Switch, message, Select, Radio, DatePicker } from "antd";
  ...
  otherRender = (text, record, column) => {
    ...
    if(editType && typeof editType === 'string'){
      switch (editType.toUpperCase()) {
        case 'INPUT':
          return getFieldDecorator(dataIndex, {initialValue: text})(<Input style={{width:200}}/>);
        case 'DATEPICKER':
